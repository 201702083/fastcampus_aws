...
Chapter 2-8. (8)Jira DB 구조 설명
...
> JIRAISSUE : 이슈에 대한 정보 제공 테이블
> ISSUESTATUS : 이슈 상태에 대한 정보 제공 테이블 

![image_2.png](./image_2.png)
> PROJECT : 프로젝트에 대한 정보를 제공 프로젝트 명 프로젝트 KEY 명등

![image_3.png](./image_3.png)
> CUSTOMFEILD : 커스텀 필드에 대한 정보를 제공
> CUSTOMFEILDVALUE : 커스텀 필드에 대한 값 정보를 제공 
> CUSTOMFEILDOPTION : 커스텀 필드의 계층 데이터 정보를 제공 (실제 텍스트 정보)

![image_4.png](./image_4.png)
> ISSUELINK : 이슈에 대한 관계성 정보 제공


디비 칼럼 및 구조 설명에 대한 상세 내용은 PPT 참고하시면 됩니다. 
